...
execute at @s[scores={blink.cooldown=0},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag: {Tags: ["blink"]}}}] anchored eyes positioned ^-0.5 ^ ^ run function blink:blink
execute at @s[scores={blink.cooldown=0},nbt={Inventory:[{Slot:-106b,id:"minecraft:carrot_on_a_stick",tag: {Tags: ["blink"]}}]}] anchored eyes positioned ^-0.5 ^ ^ run function blink:blink
